...
public class Register extends AppCompatActivity {
  ...
  //  DatabaseHelper myDataBaseHelper;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dbContect =new DbContect(this);//既是客户端优势服务器端
        //设置页面标题
        setTitle("注册账号");
        //用户名及密码
        ...
        //出生地处理
        //R.array读取String中的Array数组
        //将资源文件ID为 R.array.provinces的资源文件数组读取出来加载到系统自带的android.R.layout.simple_spinner_item下拉列表的布局文件中
        ...
        sp_Provinces.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (position == 0) {
                    ArrayAdapter cityAdapter = ArrayAdapter.createFromResource(Register.this, R.array.henan, android.R.layout.simple_spinner_item);
